...
**Importación:**
```typescript
import { Gen } from '@joroya/renderer-svg';
```
...
**Importación:**
```typescript
import { Noise } from '@joroya/renderer-svg';
...
| `SvJs` | class | Rendering | `@joroya/renderer-svg` |
| `Gen` | module | Utils | `@joroya/renderer-svg` |
| `Noise` | class | Utils | `@joroya/renderer-svg` |
