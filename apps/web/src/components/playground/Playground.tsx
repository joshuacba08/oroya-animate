...
import {
  Scene,
  Node,
  // Geometry primitives — v0.2 base + v0.6 lighting release additions.
  createBox,
  createSphere,
  createPath2D,
  createText,
  ...
  AnimationMixer,
  ComponentType,
  // v0.6+ environment / particles / lighting / instancing / FX components.
  Environment,
  FogType,
  ParticleSystem,
  PostProcessing,
  ...
  AudioListener,
  AudioSource,
  // v0.9+ physics + animator components.
  RigidBody,
  RigidBodyType,
  Collider,
  ColliderShape,
  Animator,
  // v0.12+ skinned mesh component.
  Skin,
  // v0.9+ procedural-motion math helpers + v1.0 IK solver.
  linear,
  easeInQuad,
  easeOutQuad,
  easeInOutQuad,
