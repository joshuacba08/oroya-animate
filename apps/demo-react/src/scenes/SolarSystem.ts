...
export function createSolarSystemScene(): { scene: Scene; animate: AnimateCallback } {
  const scene = new Scene();

  // Camera — elevated and pulled back for a good view
  ...
  const animate: AnimateCallback = (time) => {
    ...
    // Moon orbits the Earth much faster
